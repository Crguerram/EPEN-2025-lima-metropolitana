...
Análisis del mercado laboral en Lima Metropolitana usando microdatos de la EPEN 2025 (INEI). 
Elaboración de Dashboard en Power BI con indicadores ponderados.
...
-Analizar las diferencias por sexo y por nivel educativo.
 ...
 -Preparación y limpieza de datos: Carga del archivo csv en Power Bi, revisión y corrección de tipos de datos,creación de identificadores y de dimensiones.
